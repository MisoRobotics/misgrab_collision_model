...
class MainDataFrame:
    def __init__(self, config_dict: dict)-> None:
        ...
        # Start update_slot_dfs as a background task
        self.background_task = asyncio.create_task(self.update_slot_dfs())

    async def update_slot_dfs(self):
        while True:  # Keep running until an external interrupt
            ...
            # Add a sleep delay to prevent constant looping without pause
