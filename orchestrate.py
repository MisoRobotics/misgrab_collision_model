...
class MainDataFrame:
    def __init__(self, config_dict: dict)-> None:
        ...
        if config_dict['LOAD_CSV']:
            ...
            self.main_df = get_combined_df(self.config_dict["START_TIME"], self.config_dict["END_TIME"])
    ...
    def receive_incoming_new_row(self, incoming_new_row: pd.DataFrame) -> None:
